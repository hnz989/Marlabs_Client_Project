...
<body>
	...
	<div id="wrapper">
		<div id="container">
			<div id="header">
				<div id="logo">
					<br> <br> <br>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<strong><font color="#FFFFFF" size="+2" face="Georgia, Times New Roman, Times, serif"> Online Fraud Detection in E-Shopping <br>
								</font></strong>
				</div>
				</font></strong>
			</div>
        ...
        <li><a href="#">Link</a></li>-->
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<font size="+1" face="Georgia, Times New Roman, Times, serif" color="#00FFCC">Welcome:&nbsp;</font>
				<font size="+1" color="#FF0000"><%=sname%></font>
			</ul>
		</div>
		<!-- /navbar -->
		<div id="main">
				...
				<table height="350" align="center" width="700">
					<tr bgcolor="#CC3300">
						<td width="410" bgcolor="#FBF7E1">
							<fieldset>
								<legend>
									<strong><em><font color="#FF0000" size="+2" face="Courier New">New Products</font></em></strong>
								</legend>
								<form name="f" action="re_pro_insert.jsp" method="post" onsubmit="return valid()">
									<table cellpadding="10" cellspacing="10">
										...
										<tr>
											<td width="161" align="center"><font color="#333366"
												size="+1" face="Georgia, Times New Roman, Times, serif">
												<strong>Company Name:</strong></font></td>
											<td width="162" align="center"><input type="text" name="comname" value="<%=scname%>" id="b"></td>
										</tr>
										<tr>
											<td align="center"><font color="#333366" size="+1" face="Georgia, Times New Roman, Times, serif">
												<strong>Product Name:</strong></font></td>
											<td align="center"><input type="text" name="proname" id="b"></td>
										</tr>
										<tr>
											<td align="center"><font color="#333366" size="+1" face="Georgia, Times New Roman, Times, serif">
												<strong>Warrenty Days:</strong></font></td>
											<td align="center"><input type="text" name="wardate" id="b"></td>
										</tr>
										<tr>
											<td align="center"><font color="#333366" size="+1" face="Georgia, Times New Roman, Times, serif">
												<strong>Product Image:</strong></font></td>
											<td align="center"><input type="file" name="proimage" size="8" id="b"></td>
										</tr>
										<tr>
											<td align="center"><font color="#333366" size="+1" face="Georgia, Times New Roman, Times, serif">
												<strong>Product Rate:</strong></font></td>
						...
						<td width="200" bgcolor="#FBF7E1" align="center"><img src="product/tv.png" width="100" height="100"> <br><br><br>
						<img src="product/fridge.png" width="100" height="200"></td>
					</tr>
				</table>
			</div>
			<!-- /intro -->
		...
		<div id="footer">
			...
			<br> <br> <strong><font color="#33CC66">WWW.online.com</font></strong>
		</div>
		<!-- /footer -->
	</div>
	<!-- /container -->
